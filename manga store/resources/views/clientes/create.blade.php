        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-8 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50">
                    <h3 class="font-bold text-lg text-gray-800 dark:text-gray-200">Ficha Cadastral</h3>
                    <p class="text-xs text-gray-400 mt-1">Preencha os dados pessoais do cliente.</p>
                </div>
                ...
                <form action="{{ route('clientes.store') }}" method="POST" class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <input type="text" id="nome" name="nome" value="{{ old('nome') }}" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300">
                            @error('nome')
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300" placeholder="cliente@email.com">
                            @error('email')
                                <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <input type="text" id="telefone" name="telefone" value="{{ old('telefone') }}" placeholder="(00) 00000-0000" class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300">
                            @error('telefone')
                                <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea id="endereco" name="endereco" rows="3" class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300" placeholder="Rua, número, complemento, bairro, cidade, UF...">{{ old('endereco') }}</textarea>
                        @error('endereco')
                            <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
