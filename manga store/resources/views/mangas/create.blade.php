        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-8 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50">
                    <h3 class="font-bold text-lg text-gray-800 dark:text-gray-200">Informações do Mangá</h3>
                    <p class="text-xs text-gray-400 mt-1">Preencha todos os campos obrigatórios para registrar o mangá no catálogo da loja.</p>
                </div>

                <form action="{{ route('mangas.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <input type="text" id="titulo" name="titulo" value="{{ old('titulo') }}" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300">
                            @error('titulo')
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" id="autor" name="autor" value="{{ old('autor') }}" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300">
                            @error('autor')
                                <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" id="editora" name="editora" value="{{ old('editora') }}" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300">
                            @error('editora')
                                <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="number" id="preco" name="preco" value="{{ old('preco') }}" step="0.01" min="0" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300" placeholder="0.00">
                            @error('preco')
                                <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Estoque -->
                        <div class="space-y-1">
                            <label for="estoque" class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">Estoque Inicial <span class="text-red-500">*</span></label>
                            <input type="number" id="estoque" name="estoque" value="{{ old('estoque', 0) }}" min="0" required class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300">
                            @error('estoque')
                                <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea id="sinopse" name="sinopse" rows="4" class="w-full bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500/20 dark:text-gray-300" placeholder="Escreva uma breve sinopse do mangá...">{{ old('sinopse') }}</textarea>
                        @error('sinopse')
                            <p class="text-xs text-red-550 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
